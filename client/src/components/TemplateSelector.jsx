...
const templates = [
    {
        id:'classic',
        name:'Classic',
        preview:'A clean, treditional resume format with clear sections and professional typography'
    },
    {
        id:'modern',
        name:'Modern',
  ...
  return (
    <div className='relative'>
       <button onClick={()=>setIsOpen(!isOpen)} className='flex items-centergap-1 text-sm text-blue-600 bg-gradient-to-br from-blue-50 to-blue-100
       ring-blue-100 hover:ring transition-all px-3 py-2 rounded-lg'>
