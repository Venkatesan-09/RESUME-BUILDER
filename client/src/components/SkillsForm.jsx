  ...
  return (
    <div className='space-y-4'>
        ...
        <div className='flex gap-2'>
             ...
             transition-colors disabled:opacity-50 disabled:cursor-not-allowed' onClick={addSkill} disabled={!newSkill.trim}>
        ...
        <div className='bg-blue-50 p-3 rounded-lg'>
            <p className='text-sm text-blue-800'><strong>Tip:</strong>Add 8-12 relavent skills. Include both technical skills (programming languages,tools) and 
