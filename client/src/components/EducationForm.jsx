  ...
  return (
   <div className='space-y-6'>
       <div className='flex items-center justify-between'>
           ...
           <button onClick={addEducation} className='flex items-center justify-between gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg hover:bg-green-200
